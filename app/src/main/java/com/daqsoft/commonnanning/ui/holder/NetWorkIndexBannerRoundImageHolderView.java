...
public class NetWorkIndexBannerRoundImageHolderView extends Holder<IndexBanner> {
    ...
    public NetWorkIndexBannerRoundImageHolderView(View itemView, Activity context) {
        super(itemView);
        activity = context;
    }
    ...
    public void updateUI(IndexBanner data) {
        GlideUtils.loadImage(activity,imageView,data.getImg(),R.mipmap.common_ba_banner);
    }
}
