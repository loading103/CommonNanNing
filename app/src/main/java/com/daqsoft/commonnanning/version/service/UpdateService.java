package com.daqsoft.commonnanning.version.service;
...
public class UpdateService extends Service {
    ...
    public static void createFile(String name) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            updateDir = new File(getSDPath() + "/" + "tourist" + "/");
    ...
    public static String getSDPath() {
        ...
        boolean sdCardExist = Environment.getExternalStorageState().equals(Environment
                .MEDIA_MOUNTED);
        if (sdCardExist) {
            String projectnameis = "defaultpname";
            try {
                projectnameis = "sctourist";
            } catch (Exception e) {
                e.printStackTrace();
            }
            // 获取跟目录
            sdDir = Environment.getExternalStorageDirectory();
            return null == sdDir ? Environment.getExternalStorageDirectory().getPath() : sdDir
                    .getPath();
        } else {
            return "";
        }
