    ...
    private void initCloseEnd(){
        ...
        ButtonSpan span = new ButtonSpan(getContext(), new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (ObjectUtils.isNotEmpty(mWebContent)){
                    ARouter.getInstance().build(Constant.ACTIVITY_CONTENT_WEB).withInt("pageType", 3).withString("webContent",mWebContent).withString("mTitle","详情")
                            .navigation();
                }else {
...
//                setExpandText(originText);
    ...
    public void setCloseText(CharSequence text) {
        ...
        originText = ObjectUtils.isNotEmpty(text)?text.toString():"--";
