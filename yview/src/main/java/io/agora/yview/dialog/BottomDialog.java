...
public class BottomDialog {
    ...
    private final class CustomDialog extends Dialog {
        ...
        void inflateMenu(int menu, OnItemClickListener onItemClickListener) {
            @SuppressLint("RestrictedApi") MenuInflater menuInflater = new SupportMenuInflater
                    (getContext());
            ...
            for (int i = 0; i < menuBuilder.size(); i++) {
                ...
                items.add(new Item(menuItem.getItemId(), menuItem.getTitle().toString(), menuItem
                        .getIcon()));
            }
        ...
        private class DialogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                if (layout == GRID) return new TopHolder(new LinearLayout(parent.getContext()));
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ...
                if (layout == GRID) {
                    ...
                    topHolder.item.setCompoundDrawablesWithIntrinsicBounds(null, topHolder.icon
                            (item.getIcon()), null, null);
                    ...
                    leftHolder.item.setCompoundDrawablesWithIntrinsicBounds(leftHolder.icon(item
            ...
            class TopHolder extends RecyclerView.ViewHolder {
                ...
                TopHolder(View view) {
                    ...
                    item.setTextColor(ContextCompat.getColor(view.getContext(), R.color
                            .gray_font_dark));
                    item.setTextSize(TypedValue.COMPLEX_UNIT_PX, getContext().getResources()
                            .getDimension(R.dimen.sp_10));
                    item.setCompoundDrawablePadding(topPadding);
                    item.setPadding(0, padding, 0, padding);

                    TypedValue typedValue = new TypedValue();
                    view.getContext().getTheme().resolveAttribute(android.R.attr
                ...
                private Drawable icon(Drawable drawable) {
                    if (drawable != null) {
                        ...
                        @SuppressWarnings("SuspiciousNameCombination") Drawable resizeIcon = new
                                BitmapDrawable(getContext().getResources(), Bitmap
                                .createScaledBitmap(bitmap, topIcon, topIcon, true));
                        Drawable.ConstantState state = resizeIcon.getConstantState();
                        resizeIcon = DrawableCompat.wrap(state == null ? resizeIcon : state
                                .newDrawable().mutate());
                        return resizeIcon;
                    }
                    return null;
            ...
            class LeftHolder extends RecyclerView.ViewHolder {
                ...
                private Drawable icon(Drawable drawable) {
                    if (drawable != null) {
                        ...
                        @SuppressWarnings("SuspiciousNameCombination") Drawable resizeIcon = new
                                BitmapDrawable(getContext().getResources(), Bitmap
                                .createScaledBitmap(bitmap, leftIcon, leftIcon, true));
                        Drawable.ConstantState state = resizeIcon.getConstantState();
                        resizeIcon = DrawableCompat.wrap(state == null ? resizeIcon : state
                                .newDrawable().mutate());
                        return resizeIcon;
